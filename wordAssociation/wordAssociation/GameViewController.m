...
//        [hint2 setBackgroundImage:[UIImage imageNamed:@"Mojikeshi_on_Btn"] forState:UIControlStateNormal];
        ...
        textImageView.frame = CGRectMake(60, 20, 200, 50);
        
        coingetImageView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"Coinget"]];
        coingetImageView.backgroundColor = [UIColor clearColor];
        coingetImageView.alpha = 0.0;
        coingetImageView.frame = CGRectMake(112, 90, 96, 43);
        
        
        stageCountLabel = [[UILabel alloc] init];
        stageCountLabel.frame = CGRectMake(0, 160, 320, 100);
        stageCountLabel.alpha = 0.0;
        stageCountLabel.text = [NSString stringWithFormat:@"%d",nowStage];
        stageCountLabel.textAlignment = NSTextAlignmentCenter;
        stageCountLabel.font = [UIFont boldSystemFontOfSize:100];
        stageCountLabel.backgroundColor = [UIColor clearColor];
        stageCountLabel.textColor = [UIColor whiteColor];
        
        stageCountLabel.layer.shadowColor = [[UIColor whiteColor] CGColor];
        stageCountLabel.layer.shadowRadius = 4.0f;
        stageCountLabel.layer.shadowOpacity = .9;
        stageCountLabel.layer.shadowOffset = CGSizeZero;
        stageCountLabel.layer.masksToBounds = NO;
        
        
        stageLabel = [[UILabel alloc] init];
        stageLabel.frame = CGRectMake(100, 250, 120, 50);
        stageLabel.alpha = 0.0;
        stageLabel.text = [NSString stringWithFormat:@"問突破"];
        stageLabel.textAlignment = NSTextAlignmentCenter;
        stageLabel.font = [UIFont boldSystemFontOfSize:30];
        stageLabel.backgroundColor = [UIColor clearColor];
        stageLabel.textColor = [UIColor whiteColor];
        
        stageLabel.layer.shadowColor = [[UIColor whiteColor] CGColor];
        stageLabel.layer.shadowRadius = 4.0f;
        stageLabel.layer.shadowOpacity = .9;
        stageLabel.layer.shadowOffset = CGSizeZero;
        stageLabel.layer.masksToBounds = NO;
        
        next = [UIButton buttonWithType:UIButtonTypeCustom];
        next.frame = CGRectMake(95, 370, 174 /4*3, 52 /4*3);
        next.alpha = 0.0;
        ...
        [self.view addSubview:coingetImageView];
        [self.view addSubview:textImageView];
        [self.view addSubview:stageCountLabel];
...
//    itemListView.backgroundColor = [UIColor blueColor];
    ...
    itemListTitleView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"Title_Coinshop"]];
    itemListTitleView.frame = CGRectMake(105, 70, 110, 20);
    
    [self.view addSubview:grayView];
    [self.view addSubview:itemListView];
    [self.view addSubview:itemListTitleView];
...
//    [USER_DEFAULT synchronize];
    ...
    [UIView animateWithDuration:0.5f animations:^(void) {
        completeView.alpha = 0.9;
        coingetImageView.alpha = 1.0;
        textImageView.alpha = 1.0;
        stageCountLabel.alpha = 1.0;
